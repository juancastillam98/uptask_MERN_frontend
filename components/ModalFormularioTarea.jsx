...
export const ModalFormularioTarea = () => {
    ...
    useEffect(()=>{
        ...
        setPrioridad("")
        setFechaEntrega("")
    }, [tarea])//queremos que haga un reRender de ModalFormularioTarea
    ...
    const handleSubmit = async e =>{
        ...
        //reseteamos el state cada vez que insertemos una nueva tarea
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form
                                        ...
                                        <input
                                            type={"submit"}
                                            className={"bg-sky-600 hover:bg-sky-700 w-full p-3 text-white uppercase font-bold hover:cursor-pointer transition-colors rounded-lg"}
